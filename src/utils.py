...
def save_checkpoint(model, optimizer, best_val, epoch, checkpoint_file):
    """
    Saves checkpoint of torchvision model during training.
    :param model: torchvision model to be saved
    :param best_val: best val loss achieved so far in training
...
def load_checkpoint(model, checkpoint_file, optimizer=None):
    ...
    return checkpoint['val'], checkpoint['epoch']
